...
If you want to use Tesla's BluetoothLE protocol to communicate with the car instead, you can visit [teslabtapi.lexnastin.com](https://teslabtapi.lexnastin.com) for the documentation.
